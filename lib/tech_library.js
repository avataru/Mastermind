const weaponRegEx = /^((?:battery|laser|mass|dual|barrage)(?:[1-9]|10))$/;
const weaponHelp = 'Valid weapons are: battery, laser, mass, dual or barrage followed by a level number. e.g. battery3';

const shieldRegEx = /^((?:alpha|delta|passive|omega|mirror|area)(?:[1-9]|10))$/;
const shieldHelp = 'Valid shields are: alpha, delta, passive, omega, mirror or area followed by a level number. e.g. omega3';

const moduleRegEx = /^((?:emp|teleport|repair|warp|unity|stealth|fortify|impulse|rocket|salvage|suppress|destiny|barrier|vengeance|leap|drone)(?:[1-9]|10)|sanc1?)$/;
...
const miningRegEx = /^((?:hydrobay|boost|enrich|remote|unity|upload|crunch|genesis)(?:[1-9]|10))$/;
...
const tradeRegEx = /^((?:cargobay|computer|rush|boost|burst|autopilot|offload|beam|entrust|recall)(?:[1-9]|10))$/;
