...
var initDb = function(db) {
    db.beginTransaction((error, transaction) => {
        // achievements
        //transaction.run('DROP TABLE IF EXISTS achievements');
        ...
        // nominations
        //transaction.run('DROP TABLE IF EXISTS nominations');
...
var achievements = [
    ...
    },
    {
        ...
        description: "Tactition: Orchestrating a killer set of moves, or being a top class team leader."
    },
];
