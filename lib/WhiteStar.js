...
let WhiteStar = function (players, debug) {
...
WhiteStar.prototype.drawParticipants = function (numberOfParticipants) {
    const self = this;
...
WhiteStar.prototype.makeTeams = function (numberOfTeams) {
    const self = this;
...
WhiteStar.prototype.getEmbed = function (accentColor) {
    const self = this;
...
WhiteStar.prototype.getAscii = function () {
    const self = this;
